      ...
      <form onSubmit={handleSubmit(onLogin)}>
        ...
        <div className="flex flex-col gap-1 mb-3">
          ...
          <div className="relative w-full">
            <input
              ...
              className="w-full relative px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-blue-400 focus:ring-1"
              {...register("password", {
        ...
        <div className="flex justify-end mb-4">
          <Link
            ...
            className="text-blue-500 text-[14px] font-mono"
          >
            Quên mật khẩu?
          </Link>
        </div>
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="bg-blue-500 w-full px-3 py-4 rounded-xl text-white text-xl font-medium shadow-md mb-4 flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed cursor-pointer"
        >
          {isLoading && (
            <svg
