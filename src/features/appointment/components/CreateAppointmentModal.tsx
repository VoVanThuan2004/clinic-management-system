...
export const CreateAppointmentModal = (props: Props) => {
  ...
  const handleCreate = async () => {
    try {
      ...
      // Tạo start_time và end_time cho lịch hẹn
  ...
  const slots = generateAvailableSlots(bookedData, selectedDate as string);
  ...
  return (
    <Modal
      destroyOnClose
      title={<h1 className="text-[20px] font-semibold">Tạo lịch hẹn</h1>}
      ...
      footer={[
        ...
        <Button key="submit" type="primary" onClick={handleCreate} loading={useCreateAppointmentMutation.isPending}>
          Tạo lịch hẹn
        </Button>,
      ]}
    >
